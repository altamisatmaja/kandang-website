...
@section('title', 'Dashboard | Order Dikemas')
            ...
            <ol class="flex items-start gap-4">
                ...
                <li class="inline-flex">
                    <div
                        ...
                        <a href="{{ route('partner.order.packed') }}"> Order dikemas </a>
                    </div>
                </li>
            </ol>
        </div>
        ...
        <div class="flex flex-col">
            <div class="w-full">
                <div class="inline-block w-full py-2 align-middle">
                    <h3 class="font-semibold text-2xl text-textbase mb-5">Order dikemas, menunggu dikirim 💸</h3>

            ...
            <ol class="flex items-start gap-4">
                ...
                <li class="inline-flex">
                    <div
                        ...
                        <a href="{{ route('partner.report.list') }}"> Laporan </a>
                    </div>
                </li>
            </ol>
        </div>
            ...
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="mb-5 w-full">
                        <div class="mb-3">
                            <h3 class="font-semibold text-2xl text-textbase">Laporan 👋</h3>
                        </div>
                        <p class="text-lg text-textbase">
                            Lihat transaksi yang sudah selesai ya!
                        </p>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                @foreach ($reportdata as $report)
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">@currency($report['harga_produk'])</td>
                                        <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $report['kuantitas'] }}</td>
                                        <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">@currency($report['total_untung'])</td>
                                        <td class="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $report['catatan'] == NULL ? 'Tidak ada' : $report['catatan'] }}</td>
